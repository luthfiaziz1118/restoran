...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String colom4 = "deskripsi";
    ...
    public boolean MasukanData(String nama, String harga, String deskripsi) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues konten = new ContentValues();
        konten.put(colom2, nama);
        konten.put(colom3, harga);
        konten.put(colom4, deskripsi);
    ...
    public boolean EditData(String id, String nama, String harga, String deskripsi) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues konten = new ContentValues();
